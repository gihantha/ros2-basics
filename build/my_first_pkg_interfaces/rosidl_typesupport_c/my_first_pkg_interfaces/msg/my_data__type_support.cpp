...
static const _MyData_type_support_symbol_names_t _MyData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_first_pkg_interfaces, msg, MyData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_first_pkg_interfaces, msg, MyData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_first_pkg_interfaces, msg, MyData)() {
  return &::my_first_pkg_interfaces::msg::rosidl_typesupport_c::MyData_message_type_support_handle;
}
